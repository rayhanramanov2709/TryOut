    ...
    display = {
        ...
        mainPage: function() {
            var newEl = '<div class="quest-number"><p id="questNumber"></p></div><h1 id="questionDisplay" class="h3"></h1>';
                ...
                newEl += '<li><label><input type="radio" name="answers" id="input3" value="3"><span class="outer"><span class="inner"></span></span><div class="font_besar" id="answerDisplay3"></div></label></li>';
                newEl += '<li><label><input type="radio" name="answers" id="input4" value="4"><span class="outer"><span class="inner"></span></span><div class="font_besar" id="answerDisplay4"></div></label></li>';
				newEl += '<li><label><input type="radio" name="answers" id="input5" value="5"><span class="outer"><span class="inner"></span></span><div class="font_besar" id="answerDisplay5"></div></label></li>';
